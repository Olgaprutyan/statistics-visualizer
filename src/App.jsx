    ...
    <div className="app">
      ...
      <main className="main-content">
        ...
        <section className="content-section" id="center-height">
          ...
          <p className="section-lead">
            Начнём с очень простого случая. Пусть каждое наблюдение может
        ...
        <section className="content-section" id="observation">
          ...
          <p className="section-lead">
            Одного запуска недостаточно, чтобы увидеть закономерность.
            Проведи небольшой эксперимент и сравни результаты.
          </p>
          ...
          <div className="instruction-card">
            ...
            <ol>
              <li>
                Выбери экспоненциальное или другое заметно несимметричное
                распределение.
              </li>
              <li>Установи размер выборки n = 2 и нажми «Запустить».</li>
              <li>Затем повтори эксперимент при n = 10.</li>
              <li>После этого установи n = 50.</li>
              <li>
                Каждый раз сравни исходное распределение и распределение
                выборочных средних.
              </li>
            </ol>
          </div>
          ...
          <p className="section-transition">
            Мы увидели результат эксперимента. Теперь разберёмся, почему
            увеличение размера выборки одновременно уменьшает разброс и
            создаёт форму колокола.
          </p>
        </section>
