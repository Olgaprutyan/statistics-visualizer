  ...
  3: [
    {
      ...
      status: 'zero',
      explanation:
        'Наблюдения независимы, поэтому ожидание произведения распадается в произведение ожиданий. Каждый индекс встречается один раз — значит, появляется множитель E[Yᵢ] = 0.',
    },
    {
